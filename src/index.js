...
const KEY = '29269547-c3c4a7aec66b50e4a61abf60d';
let serchNeedImage = '';
let currentPage = 1;
...
async function fechfunction(serchNeedImage) {
  try {
    const response = await axios.get(
      `https://pixabay.com/api/?key=${KEY}&q=${serchNeedImage}&image_type=photo&orientation=horizontal&safesearch=true&page=${currentPage}&per_page=40`
    );
